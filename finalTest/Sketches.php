...
<head>
    ...
    <link rel='stylesheet' type='text/css' media='screen' href='Sketches.css'>
...
<body>
    ...
    <section>
        ...
        <div class="kategorite">
            ...
            <ul class="art">
                <a href="#" class="sketches">
                    <li>Sketches</li>
                </a>

                <li><a href="Artworks.php"><img id="logo" src="Logos/logo2.png"></a></li>
        ...
        <div class="container">
            ...
            <div class="pagebuttons">
                ...
                <a href="Artworks2.php"><button class="active">1</button></a>
